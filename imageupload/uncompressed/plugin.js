(function() {
  tinymce.create('tinymce.plugins.ImageUploadPlugin', {
    init : function(ed, url) {
      ...
      var paramStringElm = $("input[name='param-string']");
      css.type = 'text/css';
      css.rel = 'stylesheet';
      css.href = url + '/css/style.css';
      head.appendChild(css);
      if(paramStringElm)
        imageUploadUrl += ("?" + paramStringElm.val());
            ...
            <div class="imageUploadContainerInner">\
              ...
              <div class="mce-container imageUploadFormContainer" hidefocus="1" tabindex="-1">\
                <div class="mce-container-body">\
                  <input type="file" name="file" id="image-upload-area" accept="image/*" class="mce-placeholder" hidefocus="true" style="width: 258px;">\
                </div>\
